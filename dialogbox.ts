...
class DialogBox {
  ...
  CreateDialog() {
    ...
    var title : any;
    var title_text : any;
    var title_close_btn : any;
    var title_close_btn_text : any;
    var body : any;
    var body_text : any;
    var footer:any;
    var footer_confirm : any;
    var footer_confirm_text : any;
   ...
   */
  extendObject(userConfig: Object, defaults: Object): Object {
   ...
   */
  findDialogInstance(instanceClass : string = 'dialog-instance'){
    // Find instances
